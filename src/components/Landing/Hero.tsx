...
function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] md:min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20 lg:pt-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 md:space-y-8 lg:space-y-10">
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm mt-5">
                ...
                <div className="flex items-center gap-4 md:gap-6">
                  ...
                  <div className="flex -space-x-2 md:-space-x-3">
                    <Image
                      ...
                      width={48}
                      height={48}
                      className="w-10 h-10 md:w-12 md:h-12 rounded-full object-cover ring-4 ring-background"
                    />
                    <Image
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <StarIcon key={star} className="h-3 w-3 md:h-4 md:w-4 fill-amber-400 text-amber-400" />
                        ))}
                      </div>
            ...
            <div className="relative mt-8 md:mt-12 lg:mt-0 lg:pl-8">
              {/* GRADIENT ORBS */}
